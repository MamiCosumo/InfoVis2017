...
function main()
{
    ...
    geometry.faces[1].color = new THREE.Color( 1,0.6,0 );
    geometry.faces[2].color = new THREE.Color( 0.9,1,0 );
    geometry.faces[3].color = new THREE.Color( 0,1,0 );
    geometry.faces[4].color = new THREE.Color( 0,1,0.8 );
    geometry.faces[5].color = new THREE.Color( 0,0.5,1 );
    geometry.faces[6].color = new THREE.Color( 0,0,1 );
    geometry.faces[7].color = new THREE.Color( 0.4,0,1 );
    geometry.faces[8].color = new THREE.Color( 1,0,0.8 );
